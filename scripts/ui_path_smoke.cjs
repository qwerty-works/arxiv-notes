...
const home = files.find((f) => f.endsWith(path.join('arxiv-notes','index.html')) || f.endsWith('index.html'));
...
const fav = files.find((f) => f.includes(path.join('arxiv-notes','favorites','index.html')));
if (fav){
