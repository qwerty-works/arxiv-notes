...
(Earlier sections refer to “prompt #N”.)

### Prompt #1: Pensieve loop controller (search → read → note → delete)
...
### Prompt #2: Note schema that survives deletion (compact but audit-friendly)
...
### Prompt #3: Needle-in-a-haystack memory test generator
...
- Smarter test-time compute for agents: <https://qwerty-works.github.io/arxiv-notes/2602.12276/agentic-test-time-scaling-for-webagents/>
- Reliability gaps in speech models: <https://qwerty-works.github.io/arxiv-notes/2602.12249/sorry-i-didnt-catch-that/>
